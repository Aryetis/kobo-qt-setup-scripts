...
SYSROOT=${SYSROOT:=${HOME}/x-tools/${CROSS_TC}/${CROSS_TC}/sysroot}
CROSS=${CROSS:=${HOME}/x-tools/${CROSS_TC}/bin/${CROSS_TC}}

PREFIX_KOBO=${PREFIX:-${HOME}/qt-bin/${LOCALREPO_KOBO}}
PREFIX_DESKTOP=${PREFIX:-${HOME}/qt-bin/${LOCALREPO_DESKTOP}}
